...
pygame.init()
game_font = pygame.font.SysFont("Ubuntu", 30)
...
def apply_player_movement():
    ...
    if p1_up:
        ...
        p1_y_pos = min(p1_y_pos + paddle_speed, HEIGHT - 80)
    if p2_up:
        p2_y_pos = max(p2_y_pos - paddle_speed, 0)
    elif p2_down:
        p2_y_pos = min(p2_y_pos + paddle_speed, HEIGHT - 80)
...
pygame.display.set_caption("Jamin-Pong v0.l")
screen.fill(BLACK)
pygame.display.flip() 
